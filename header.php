<!DOCTYPE html>
 ...
 <meta charset="utf-8" />
 <meta name="description" content="Palladam || Government Arts and Science College" />
 <meta name="keywords" content="Government college palladam, Arts college palladam, Arts and science college palladam" />
 <meta name="author" content="shakthisoftsolutions" />
 <title>Puratchi Thalaivi Amma Government Arts and Science College, Palladam</title>
 ...
 <ul>
 <li><i class="fa fa-phone"></i>+91 425 5251144 , +91 425 5251145</li>
 <li><i class="fa fa-envelope-o"></i><a href="" class="__cf_email__">principalpalladam@gmail.com</a></li>
 </ul>
 </div>
 </div>
 ...
 <div class="col-md-2 col-sm-12 col-xs-8 menu-left">
 <div class="logo">
 <a href="index.html"><img src="img/govt-logo.jpg" style="height: 85px;" /></a>
 </div>
 </div>
...
<br>ESTD - 2017
 ...
 <div class="col-md-2 col-sm-12 col-xs-8 menu-right">
 <div class="logo">
 <a href="index.html"><img src="img/govt-logo.jpg" style="height: 85px;" /></a>
 </div>
 </div>
 ...
 <div class="col-md-12 col-sm-9 menu-left">
 <div class="menu">
 ...
 <ul>
 <li><a href="#">UG Programmes </a></li>
 <li><a href="#">PG Programmes </a></li>
 <li><a href="#">Research Programmes </a></li>
 </ul>
 </li>
 <li><a href="#">Departments <i class="fa fa-angle-right"></i></a>
 <ul>
 <li><a href="department.php?dept_ID=1">Tamil Department </a></li>
 <li><a href="department.php?dept_ID=2">English Department </a></li>
 <li><a href="department.php?dept_ID=3">Mathematics Department </a></li>
 <li><a href="department.php?dept_ID=4">Commerce Department </a></li>
 <li><a href="department.php?dept_ID=5">Computer Science Department </a></li>
 <li><a href="department.php?dept_ID=6">Chemistry Department </a></li>
