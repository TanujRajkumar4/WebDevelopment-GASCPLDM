      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-2 col-sm-12 col-xs-8 menu-left">
            <div class="logo">
              <a href="index.html"><img src="img/govt-clg.jpg" /></a>
            </div>
          </div>
          <div class="col-md-8 col-sm-12 col-xs-8 menu-center">
            <a href="index.html">
              <center style="padding-top: 20px;">
                <h1>Puratchi Thalaivi Amma Government Arts and Science College, Palladam</h1>
                <h3>(Affiliated to Bharathiar University, Coimbatore)
                  <a href="index.php">
                    <center style="padding-top: 20px;">
                      <h1>புரட்சித்தலைவி அம்மா அரசு கலை மற்றும் அறிவியல் கல்லூரி, பல்லடம்
                        <br><br>ESTD - 2017
                </h3>
              </center>
            </a>
          ...
          <div class="col-md-2 col-sm-12 col-xs-8 menu-right">
            <div class="logo">
              <a href="index.html"><img src="img/govt-logo.jpg" /></a>
            </div>
          </div>
        </div>
      </div>
 ...
 <li><a href="./page.php?page_id=5">Alumni Association</a></li-->
                  ...
                  <li><a href="#">Administration </a>
                    <ul>
                      ...
                      <li><a href="./page.php?page_id=18">Rules and Regulations</a></li>
                    ...
                    <ul>
                      ...
                      <li><a href="#">Departments <i class="fa fa-angle-right"></i></a>
                        <ul>
                          ...
                          <li><a href="department.php?dept_ID=4">Department of Commerce </a></li>
