...
<?php
    ...
    include 'db.php';
	$result=mysqli_query($con, "select * from eve where news_id='$_GET[id]'");
    $row=mysqli_fetch_array($result);
	$gallery=$row['news_photo'];
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple" >
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="newspotoedit2.php?id=<?php echo $row['news_id']?>&type=<?php echo $_GET['type'];?>"  class="form-horizontal"  method="POST" enctype="multipart/form-data"  >
								...
								<label class="control-label col-md-7">Images<span class="required" aria-required="true">
								* </span>
								</label>
								<div class="col-md-7">
